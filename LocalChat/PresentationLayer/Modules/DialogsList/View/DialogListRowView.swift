...
#Preview {
  let me = User(userType: .selfUser, name: "Mike", phone: "123", avatarTitle: nil, isOnline: true)
  let user = User(userType: .anotherUser, name: "John", phone: "1123", avatarTitle: nil, isOnline: true)
