...
class MockDialogsService: DialogsServiceProtocol {
  ...
  func getDialogsList() -> [Dialog] {
    var dialogs = [Dialog]()
    let me = User(userType: .selfUser, name: "Mike", phone: "123", avatar: UIImage(named: "Me"), isOnline: true)
    let user1 = User(userType: .anotherUser, name: "John Poster", phone: "1123", avatar: UIImage(named: "mock_1"), isOnline: true)
    ...
    let user2 = User(userType: .anotherUser, name: "Bob Robins", phone: "1123", avatar: nil, isOnline: false)
    ...
    let user4 = User(userType: .anotherUser, name: "Rob Stark", phone: "1123", avatar: UIImage(named: "mock_3"), isOnline: true)
    ...
    let user5 = User(userType: .anotherUser, name: "Jim Bim", phone: "1123", avatar: nil, isOnline: false)
    ...
    let user6 = User(userType: .anotherUser, name: "Antony Blinkin", phone: "1123", avatar: nil, isOnline: true)
    ...
    let user7 = User(userType: .anotherUser, name: "Vladimir Rezanov", phone: "1123", avatar: nil, isOnline: true)
