...
class MockDialogsService: DialogsServiceProtocol {
  ...
  func getDialogsList() -> [Dialog] {
    var dialogs = [Dialog]()
    let me = User(userType: .selfUser, name: "Mike", passsword: "123", avatar: UIImage(named: "Me"), isOnline: true)
    let user1 = User(userType: .anotherUser, name: "John Poster", passsword: "1123", avatar: UIImage(named: "mock_1"), isOnline: true)
    ...
    let user2 = User(userType: .anotherUser, name: "Bob Robins", passsword: "1123", avatar: nil, isOnline: false)
    ...
    let user3 = User(userType: .anotherUser, name: "Sarra Bold", passsword: "1123", avatar: UIImage(named: "mock_2"), isOnline: false)
    ...
    let user4 = User(userType: .anotherUser, name: "Rob Stark", passsword: "1123", avatar: UIImage(named: "mock_3"), isOnline: true)
    ...
    let user5 = User(userType: .anotherUser, name: "Jim Bim", passsword: "1123", avatar: nil, isOnline: false)
    ...
    let user6 = User(userType: .anotherUser, name: "Antony Blinkin", passsword: "1123", avatar: nil, isOnline: true)
    ...
    let user7 = User(userType: .anotherUser, name: "Vladimir Rezanov", passsword: "1123", avatar: nil, isOnline: true)
